...
HD_PWD='C:/Users/jjnat/Vault 451/Quote/Projects/Digital Design Techniques and Verification/Final Project/Digital-Lock-Custom-16-bit-RISC-Soc/src/src.runs/impl_1'
cd "$HD_PWD"
