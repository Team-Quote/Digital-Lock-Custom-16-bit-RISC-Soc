...
HD_PWD='C:/Users/jjnat/Vault 451/Quote/Projects/Digital Design Techniques and Verification/Final Project/Digital-Lock-Custom-16-bit-RISC-Soc/srcV2/srcV2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISC_CPU.tcl -notrace
