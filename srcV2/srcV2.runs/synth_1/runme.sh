...
HD_PWD='C:/Users/jjnat/Vault 451/Quote/Projects/Digital Design Techniques and Verification/Final Project/Digital-Lock-Custom-16-bit-RISC-Soc/srcV2/srcV2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_CPU.tcl
